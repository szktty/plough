...
void main() {
  ...
  testWidgets(
    ...
    g.addLink(GraphLink(
        source: n3, target: n4, direction: GraphLinkDirection.outgoing));

    g.addLink(
        GraphLink(source: n5, target: n6, direction: GraphLinkDirection.none));
    g.addLink(GraphLink(
        source: n6, target: n7, direction: GraphLinkDirection.outgoing));
    g.addLink(GraphLink(
        source: n7, target: n8, direction: GraphLinkDirection.bidirectional));

    g.addLink(GraphLink(
        source: n9, target: n10, direction: GraphLinkDirection.outgoing));
    g.addLink(GraphLink(
        source: n10, target: n11, direction: GraphLinkDirection.outgoing));
    g.addLink(GraphLink(
        source: n11, target: n12, direction: GraphLinkDirection.none));

    // Columns (some reversed to vary arrowheads)
    g.addLink(GraphLink(
        source: n1, target: n5, direction: GraphLinkDirection.outgoing));
    g.addLink(GraphLink(
        source: n5, target: n9, direction: GraphLinkDirection.outgoing));

    g.addLink(GraphLink(
        source: n4, target: n8, direction: GraphLinkDirection.outgoing));
    g.addLink(GraphLink(
        source: n8, target: n12, direction: GraphLinkDirection.outgoing));

    // Diagonals for complexity
    g.addLink(GraphLink(
        source: n2, target: n6, direction: GraphLinkDirection.outgoing));
    g.addLink(GraphLink(
        source: n7, target: n11, direction: GraphLinkDirection.outgoing));
    g.addLink(GraphLink(
        source: n3, target: n7, direction: GraphLinkDirection.outgoing));
